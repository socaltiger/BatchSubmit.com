...
%make_empty_dataset(metadatafile=..\appendix_b\SDTM_METADATA.xlsx,dataset=DM)
...
%make_empty_dataset(metadatafile=..\appendix_b\SDTM_METADATA.xlsx,dataset=SUPPDM)
...
%make_sort_order(metadatafile=..\appendix_b\SDTM_METADATA.xlsx,dataset=DM)
...
%make_sort_order(metadatafile=..\appendix_b\SDTM_METADATA.xlsx,dataset=SUPPDM)
