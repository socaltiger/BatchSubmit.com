...
autos_data <- read.table("C:\\Apache\\htdocs\\casper2\\Main\\Examples\\R\\autos.dat", header=T, sep="\t") 
...
png(filename="C:\\Apache\\htdocs\\casper2\\Main\\Examples\\R\\autos.png", height=295, width=300, 
 bg="white")
