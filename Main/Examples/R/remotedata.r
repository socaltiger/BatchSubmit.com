# Read car and truck values from tab-delimited autos.dat from web

require("RCurl")

autos_data <- read.table(textConnection(getURL("http://batchsubmit.com/casper2/Main/Examples/R/autos.dat")),header=TRUE)
...
png(filename="C:\\Apache\\htdocs\\casper2\\Main\\Examples\\R\\remotedata.png", height=295, width=300, 
 bg="white")
