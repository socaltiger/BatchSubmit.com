...
#      print "     </tr>\n";	 	  
      ...
      print "     <TD valign=top width=100% bgColor=#dbe6e0>\n";
      print "       <TABLE cellSpacing=0 cellPadding=4 width=100% border=0>\n";
      print "       <tr bgColor=#99bcd8><td colspan=2 width=100%><font color=white>Tasks</font></td></tr>\n";
	...
	print "<textarea readonly rows=4 width=100% wrap=off>\n";
	...
	print "<textarea readonly rows=16 cols=100% wrap=off>\n";
